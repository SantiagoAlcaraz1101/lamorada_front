...
Integración local para F01–F04, F07 (perfil propio), F13–F16, F17 (crear publicación)
y F26–F27, según la ampliación solicitada del plan 2.0.
...
contenedores exclusivos de pruebas, ejecuta las suites explícitas del alcance, unifica
la cobertura, envía el análisis y espera su procesamiento antes de exportar.
El Quality Gate Q10 se informa aunque resulte ERROR. El runner conserva los
informes y termina con código 2 si Q10 no aprueba; código 1 indica un fallo técnico
o de pruebas. Q10 exige cobertura nueva >=90%, duplicación nueva <=2%, 0 issues
nuevos, 100% hotspots nuevos revisados y deuda nueva de mantenibilidad <=90 minutos.
No se cambian sus umbrales ni su período de código nuevo.
...
de la atribución mediante marcadores. No se analizan podcasts ni pagos. F17
incorpora creación y su refresco posterior, pero no edición ni eliminación de
publicaciones. Se incluyen dependencias de las funciones, por ejemplo la
...
Las 98 pruebas originales siguen pasando. En Q10 se combinan con las 4 pruebas
de plantillas y las nuevas suites plan20/quality. Para ejecutar solo las 4:
...
El informe vigente está en docs/quality-q10/RESULTADOS.md de cada repositorio.
Los informes docs/sonarqube/ conservan el ciclo anterior sin reescribir sus métricas.
Los merges anteriores de evidencia usan las ramas
...
y de la configuración vigente queda versionada en frontend/docs/quality-q10/workspace/.
