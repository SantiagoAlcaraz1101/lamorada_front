...
if (output.gate.conditions.length) {
  md += '\n## Por qué el Quality Gate no aprueba\n\n';
...
md += `Backend: ${tests.numPassedTests}/${tests.numTotalTests} pruebas aprobadas. Frontend: ${testRun.frontend ? `${frontendCount} pruebas aprobadas` : 'falló'}. Solo se ejecutaron whitebox.paths.test.js, delivery.functional.test.js y delivery.paths.spec.ts. MongoDB/Redis fueron contenedores desechables separados.\n\n`;
